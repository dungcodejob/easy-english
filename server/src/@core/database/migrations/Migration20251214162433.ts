...
export class Migration20251214162433 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`create table "word_entity" ("id" uuid not null default uuidv7(), "create_at" timestamptz not null default current_timestamp, "update_at" timestamptz not null default current_timestamp, "deleted_at" timestamptz null, "delete_flag" boolean not null default false, "tenant_id" uuid not null, "word" varchar(255) not null, "definition" text null, "definitions" jsonb null, "pronunciation" varchar(255) null, "audio_url" varchar(255) null, "part_of_speech" text[] null, "examples" text[] null, "synonyms" text[] null, "antonyms" text[] null, "personal_note" text null, "media_urls" jsonb null, "difficulty" int not null default 1, "custom_fields" jsonb null, "from_oxford_api" boolean not null default false, "oxford_data" jsonb null, "review_count" int not null default 0, "last_reviewed_at" timestamptz null, "topic_id" uuid not null, constraint "word_entity_pkey" primary key ("id"));`);

    this.addSql(`alter table "topic_entity" add constraint "topic_entity_tenant_id_foreign" foreign key ("tenant_id") references "tenant_entity" ("id") on update cascade;`);
